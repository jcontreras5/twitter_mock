...
class User(db.Model,UserMixin): #3 create class user and inherit  SQLA Models class 
    ...
    # = db.relationship('Player', backref='manager', lazy = True) #4 if you do soccer_locker.user_token.author will join User and locker table and show the instance of matching id
